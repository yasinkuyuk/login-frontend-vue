   ...
   <b-navbar type="dark" variant="dark">
      ...
      <b-navbar-nav>
        <b-nav-item-dropdown :text="$t('lang')" right>
          <b-dropdown-item @click="switchLanguage('en')"><CountryFlag country='gb' size='medium'/>EN</b-dropdown-item>
          <b-dropdown-item @click="switchLanguage('tr')"><CountryFlag country='tr' size='medium'/>TR</b-dropdown-item>
        </b-nav-item-dropdown>
      </b-navbar-nav>
    </b-navbar> 
  </div>
